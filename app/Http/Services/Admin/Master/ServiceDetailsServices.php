    ...
    public function addAll($request)
{
    ...
    //         $path = Config::get('DocumentConstant.SERVICE_DETAILS_ADD');
    //         if ($request->hasFile('image')) {
    //             if ($return_data['image']) {
    //                 if (file_exists_view(Config::get('DocumentConstant.SERVICE_DETAILS_DELETE') . $return_data['image'])) {
    //                     removeImage(Config::get('DocumentConstant.SERVICE_DETAILS_DELETE') . $return_data['image']);
    //                 }
