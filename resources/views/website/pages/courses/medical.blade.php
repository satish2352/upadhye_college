                ...
                <div class="edu-card card-type-3 radius-small">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details.html">
                                <img class="w-100" src="{{ asset('website/assets/images/course/course-01/NEET(1).jpg')}}" alt="Course Thumb">
                            </a>
                    ...
                    <div class="card-hover-action">
                        <div class="hover-content">
                            ...
                            {{-- <h6 class="title"><a href="course-details.html">NEET</a></h6> --}}

                            <p class="description">Based on a written test that will be objective & syllabus is Science & Maths of Class IX & X Board.
                            </p>
                ...
                <div class="col-12 col-sm-12 col-xl-4 col-md-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="edu-card card-type-3 radius-small">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="course-details.html">
                                    <img class="w-100" src="{{ asset('website/assets/images/course/course-01/NEET(2).jpg')}}" alt="Course Thumb">
                                </a>
                                <div class="wishlist-top-right">
                                    {{-- <button class="wishlist-btn"><i class="icon-Heart"></i></button> --}}
                                </div>
                        ...
                        <div class="card-hover-action">
                            <div class="hover-content">
                                ...
                                {{-- <h6 class="title"><a href="course-details.html">AIIMS</a></h6> --}}
    
                                <p class="description">Based on a written test that will be objective & the syllabus is Science & Maths of Class IX & X Board.</p>
                ...
                <div class="edu-card card-type-3 radius-small">
                    ...
                    <div class="card-hover-action">
                        <div class="hover-content">
                            ...
                            {{-- <h6 class="title"><a href="course-details.html">CET</a></h6> --}}
