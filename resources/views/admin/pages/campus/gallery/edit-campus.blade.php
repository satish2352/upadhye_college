        ...
        <div class="content-wrapper mt-6">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action="{{ route('update-campus') }}" method="post" id="regForm"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="imageType" id="dropdown" class="form-control">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.CAMPUS_GALLERY_VIEW') }}{{ $editData->image }}"
