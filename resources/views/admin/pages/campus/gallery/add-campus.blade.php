        ...
        <div class="content-wrapper mt-6">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action="{{ route('add-campus') }}" method="POST" enctype="multipart/form-data" id="regForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 text-center">
                                    ...
                                    <span><a href="{{ route('list-campus') }}" class="btn btn-sm btn-primary">Back</a></span>
                                </div>
                            </div>
                        </form>
