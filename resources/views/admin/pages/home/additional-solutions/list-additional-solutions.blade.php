...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper mt-7">
            <div class="page-header">
                <h3 class="page-title">
                    ...
                    <a href="{{ route('add-additional-solutions') }}" class="btn btn-sm btn-primary ml-3">+
                        Add</a>
                                            ...
                                            <tbody>
                                                @foreach ($getOutput as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('edit-additional-solutions', base64_encode($item->id)) }}"
        ...
        <form method="POST" action="{{ url('/delete-additional-solutions') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-additional-solutions') }}" id="showform">
            @csrf
            <input type="hidden" name="show_id" id="show_id" value="">
        </form>
        <form method="POST" action="{{ url('/update-active-additional-solutions') }}" id="activeform">
            @csrf
